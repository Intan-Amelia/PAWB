...
<html lang="en">
  <head>
	...
	<link rel="icon" href="assets/images/UTM.png" type="image/ico" />
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="assets/images/intan.png" alt="..." class="img-circle profile_img">
              </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-desktop"></i> Data Mahasiswa <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="index.php?page=Add Data">Tambah Data</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/intan.png" alt="">Intan Amelia
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2022 Data Mahasiswa : Intan Amelia
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
